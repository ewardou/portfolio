...
function About(){
    ...
    <section id="about">
        ...
        <p>I love learning, and I am always looking for new challenges and opportunities to grow and improve. This portfolio contains some of the projects I've done while making my way through the curriculum.</p>
        <img src={pfp} alt=""/>
        <h2>Skills</h2>
